                        ...
                        <table class="table table-hover mb-0" id="userTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>Email</th>
                                    <th>Role</th>
                                    <th>Position<span class="sort-icon"><i class="bi"></i></span></th>
                                    <th>Department<span class="sort-icon"><i class="bi"></i></span></th>
                                    <th>Company<span class="sort-icon"><i class="bi"></i></span></th>
